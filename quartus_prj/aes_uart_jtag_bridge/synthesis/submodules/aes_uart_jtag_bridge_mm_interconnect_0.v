// aes_uart_jtag_bridge_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module aes_uart_jtag_bridge_mm_interconnect_0 (
		output wire [31:0] aes_uart_0_altera_axi4lite_slave_awaddr,                      //                       aes_uart_0_altera_axi4lite_slave.awaddr
		output wire [2:0]  aes_uart_0_altera_axi4lite_slave_awprot,                      //                                                       .awprot
		output wire        aes_uart_0_altera_axi4lite_slave_awvalid,                     //                                                       .awvalid
		input  wire        aes_uart_0_altera_axi4lite_slave_awready,                     //                                                       .awready
		output wire [31:0] aes_uart_0_altera_axi4lite_slave_wdata,                       //                                                       .wdata
		output wire [3:0]  aes_uart_0_altera_axi4lite_slave_wstrb,                       //                                                       .wstrb
		output wire        aes_uart_0_altera_axi4lite_slave_wvalid,                      //                                                       .wvalid
		input  wire        aes_uart_0_altera_axi4lite_slave_wready,                      //                                                       .wready
		input  wire [1:0]  aes_uart_0_altera_axi4lite_slave_bresp,                       //                                                       .bresp
		input  wire        aes_uart_0_altera_axi4lite_slave_bvalid,                      //                                                       .bvalid
		output wire        aes_uart_0_altera_axi4lite_slave_bready,                      //                                                       .bready
		output wire [31:0] aes_uart_0_altera_axi4lite_slave_araddr,                      //                                                       .araddr
		output wire [2:0]  aes_uart_0_altera_axi4lite_slave_arprot,                      //                                                       .arprot
		output wire        aes_uart_0_altera_axi4lite_slave_arvalid,                     //                                                       .arvalid
		input  wire        aes_uart_0_altera_axi4lite_slave_arready,                     //                                                       .arready
		input  wire [31:0] aes_uart_0_altera_axi4lite_slave_rdata,                       //                                                       .rdata
		input  wire [1:0]  aes_uart_0_altera_axi4lite_slave_rresp,                       //                                                       .rresp
		input  wire        aes_uart_0_altera_axi4lite_slave_rvalid,                      //                                                       .rvalid
		output wire        aes_uart_0_altera_axi4lite_slave_rready,                      //                                                       .rready
		input  wire        clk_0_clk_clk,                                                //                                              clk_0_clk.clk
		input  wire        aes_uart_0_reset_sink_reset_bridge_in_reset_reset,            //            aes_uart_0_reset_sink_reset_bridge_in_reset.reset
	...
	wire          cmd_mux_src_valid;                                                  // cmd_mux:src_valid -> aes_uart_0_altera_axi4lite_slave_agent:write_cp_valid
	wire  [101:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> aes_uart_0_altera_axi4lite_slave_agent:write_cp_data
	wire          cmd_mux_src_ready;                                                  // aes_uart_0_altera_axi4lite_slave_agent:write_cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> aes_uart_0_altera_axi4lite_slave_agent:write_cp_channel
	wire          cmd_mux_src_startofpacket;                                          // cmd_mux:src_startofpacket -> aes_uart_0_altera_axi4lite_slave_agent:write_cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                            // cmd_mux:src_endofpacket -> aes_uart_0_altera_axi4lite_slave_agent:write_cp_endofpacket
	wire          cmd_mux_001_src_valid;                                              // cmd_mux_001:src_valid -> aes_uart_0_altera_axi4lite_slave_agent:read_cp_valid
	wire  [101:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> aes_uart_0_altera_axi4lite_slave_agent:read_cp_data
	wire          cmd_mux_001_src_ready;                                              // aes_uart_0_altera_axi4lite_slave_agent:read_cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> aes_uart_0_altera_axi4lite_slave_agent:read_cp_channel
	wire          cmd_mux_001_src_startofpacket;                                      // cmd_mux_001:src_startofpacket -> aes_uart_0_altera_axi4lite_slave_agent:read_cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                        // cmd_mux_001:src_endofpacket -> aes_uart_0_altera_axi4lite_slave_agent:read_cp_endofpacket
	...
	wire          aes_uart_0_altera_axi4lite_slave_agent_write_rp_valid;              // aes_uart_0_altera_axi4lite_slave_agent:write_rp_valid -> router_001:sink_valid
	wire  [101:0] aes_uart_0_altera_axi4lite_slave_agent_write_rp_data;               // aes_uart_0_altera_axi4lite_slave_agent:write_rp_data -> router_001:sink_data
	wire          aes_uart_0_altera_axi4lite_slave_agent_write_rp_ready;              // router_001:sink_ready -> aes_uart_0_altera_axi4lite_slave_agent:write_rp_ready
	wire          aes_uart_0_altera_axi4lite_slave_agent_write_rp_startofpacket;      // aes_uart_0_altera_axi4lite_slave_agent:write_rp_startofpacket -> router_001:sink_startofpacket
	wire          aes_uart_0_altera_axi4lite_slave_agent_write_rp_endofpacket;        // aes_uart_0_altera_axi4lite_slave_agent:write_rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          aes_uart_0_altera_axi4lite_slave_agent_read_rp_valid;               // aes_uart_0_altera_axi4lite_slave_agent:read_rp_valid -> router_002:sink_valid
	wire  [101:0] aes_uart_0_altera_axi4lite_slave_agent_read_rp_data;                // aes_uart_0_altera_axi4lite_slave_agent:read_rp_data -> router_002:sink_data
	wire          aes_uart_0_altera_axi4lite_slave_agent_read_rp_ready;               // router_002:sink_ready -> aes_uart_0_altera_axi4lite_slave_agent:read_rp_ready
	wire          aes_uart_0_altera_axi4lite_slave_agent_read_rp_startofpacket;       // aes_uart_0_altera_axi4lite_slave_agent:read_rp_startofpacket -> router_002:sink_startofpacket
	wire          aes_uart_0_altera_axi4lite_slave_agent_read_rp_endofpacket;         // aes_uart_0_altera_axi4lite_slave_agent:read_rp_endofpacket -> router_002:sink_endofpacket
	...
	altera_merlin_axi_slave_ni #(
	...
	) aes_uart_0_altera_axi4lite_slave_agent (
		.aclk                   (clk_0_clk_clk),                                                 //        clock_sink.clk
		.aresetn                (~aes_uart_0_reset_sink_reset_bridge_in_reset_reset),            //        reset_sink.reset_n
		...
		.read_rp_ready          (aes_uart_0_altera_axi4lite_slave_agent_read_rp_ready),          //           read_rp.ready
		.read_rp_valid          (aes_uart_0_altera_axi4lite_slave_agent_read_rp_valid),          //                  .valid
		.read_rp_data           (aes_uart_0_altera_axi4lite_slave_agent_read_rp_data),           //                  .data
		.read_rp_startofpacket  (aes_uart_0_altera_axi4lite_slave_agent_read_rp_startofpacket),  //                  .startofpacket
		.read_rp_endofpacket    (aes_uart_0_altera_axi4lite_slave_agent_read_rp_endofpacket),    //                  .endofpacket
		.write_rp_ready         (aes_uart_0_altera_axi4lite_slave_agent_write_rp_ready),         //          write_rp.ready
		.write_rp_valid         (aes_uart_0_altera_axi4lite_slave_agent_write_rp_valid),         //                  .valid
		.write_rp_data          (aes_uart_0_altera_axi4lite_slave_agent_write_rp_data),          //                  .data
		.write_rp_startofpacket (aes_uart_0_altera_axi4lite_slave_agent_write_rp_startofpacket), //                  .startofpacket
		.write_rp_endofpacket   (aes_uart_0_altera_axi4lite_slave_agent_write_rp_endofpacket),   //                  .endofpacket
		.awaddr                 (aes_uart_0_altera_axi4lite_slave_awaddr),                       // altera_axi_master.awaddr
		.awprot                 (aes_uart_0_altera_axi4lite_slave_awprot),                       //                  .awprot
		.awvalid                (aes_uart_0_altera_axi4lite_slave_awvalid),                      //                  .awvalid
		.awready                (aes_uart_0_altera_axi4lite_slave_awready),                      //                  .awready
		.wdata                  (aes_uart_0_altera_axi4lite_slave_wdata),                        //                  .wdata
		.wstrb                  (aes_uart_0_altera_axi4lite_slave_wstrb),                        //                  .wstrb
		.wvalid                 (aes_uart_0_altera_axi4lite_slave_wvalid),                       //                  .wvalid
		.wready                 (aes_uart_0_altera_axi4lite_slave_wready),                       //                  .wready
		.bresp                  (aes_uart_0_altera_axi4lite_slave_bresp),                        //                  .bresp
		.bvalid                 (aes_uart_0_altera_axi4lite_slave_bvalid),                       //                  .bvalid
		.bready                 (aes_uart_0_altera_axi4lite_slave_bready),                       //                  .bready
		.araddr                 (aes_uart_0_altera_axi4lite_slave_araddr),                       //                  .araddr
		.arprot                 (aes_uart_0_altera_axi4lite_slave_arprot),                       //                  .arprot
		.arvalid                (aes_uart_0_altera_axi4lite_slave_arvalid),                      //                  .arvalid
		.arready                (aes_uart_0_altera_axi4lite_slave_arready),                      //                  .arready
		.rdata                  (aes_uart_0_altera_axi4lite_slave_rdata),                        //                  .rdata
		.rresp                  (aes_uart_0_altera_axi4lite_slave_rresp),                        //                  .rresp
		.rvalid                 (aes_uart_0_altera_axi4lite_slave_rvalid),                       //                  .rvalid
		.rready                 (aes_uart_0_altera_axi4lite_slave_rready)                        //                  .rready
	);

	aes_uart_jtag_bridge_mm_interconnect_0_router router (
	...
	aes_uart_jtag_bridge_mm_interconnect_0_router_001 router_001 (
		.sink_ready         (aes_uart_0_altera_axi4lite_slave_agent_write_rp_ready),         //      sink.ready
		.sink_valid         (aes_uart_0_altera_axi4lite_slave_agent_write_rp_valid),         //          .valid
		.sink_data          (aes_uart_0_altera_axi4lite_slave_agent_write_rp_data),          //          .data
		.sink_startofpacket (aes_uart_0_altera_axi4lite_slave_agent_write_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (aes_uart_0_altera_axi4lite_slave_agent_write_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (aes_uart_0_reset_sink_reset_bridge_in_reset_reset),             // clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_router_001 router_002 (
		.sink_ready         (aes_uart_0_altera_axi4lite_slave_agent_read_rp_ready),         //      sink.ready
		.sink_valid         (aes_uart_0_altera_axi4lite_slave_agent_read_rp_valid),         //          .valid
		.sink_data          (aes_uart_0_altera_axi4lite_slave_agent_read_rp_data),          //          .data
		.sink_startofpacket (aes_uart_0_altera_axi4lite_slave_agent_read_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (aes_uart_0_altera_axi4lite_slave_agent_read_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (aes_uart_0_reset_sink_reset_bridge_in_reset_reset),            // clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                //        clk.clk
		.reset              (master_0_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (aes_uart_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (aes_uart_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (aes_uart_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (aes_uart_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aes_uart_jtag_bridge_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                //       clk.clk
		.reset               (master_0_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
